...
export default function Home() {
	...
	return (
		...
		<Card className="flex-col items-center justify-center p-4 mt-2 mb-2 w-full cursor-pointer bg-primary text-white shadow-2xl" isPressable onClick={() => push('/timetable')}>
			<h1 className="text-2xl text-left w-full">시간표로 이동</h1>
		</Card>
		<Card className="flex-col items-center justify-center p-4 mt-2 mb-2 w-full cursor-pointer bg-primary text-white shadow-2xl" isPressable onClick={() => push('/calculator')}>
			<h1 className="text-2xl text-left w-full">학점계산기</h1>
		</Card>
		<Card className="flex-col items-center justify-center p-4 mt-2 mb-2 w-full cursor-pointer bg-primary text-white shadow-2xl" isPressable onClick={() => push('/notice')}>
