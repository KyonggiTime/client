	...
	return (
		...
		<div className="flex flex-wrap gap-4 justify-center">
			...
			</Card>
			{
				auth.isLoggedIn ?
				(
					<Card className="flex-col items-center justify-center w-[45%] p-4 cursor-pointer bg-primary-400 text-white shadow-2xl" isPressable onClick={() => push('https://dev.jinhy.uk/google/logout')}>
						<h1 className="flex items-center text-2xl"><FaGoogle />&nbsp;로그아웃</h1>
					</Card>
				) :	
				(
					<Card className="flex-col items-center justify-center w-[45%] p-4 cursor-pointer bg-primary-400 text-white shadow-2xl" isPressable onClick={() => push('https://dev.jinhy.uk/google')}>
